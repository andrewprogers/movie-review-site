...
feature "User Signs In" do
  ...
  # If they supply invalid credentials, they should be given an error message and remain on the same page
  # If they supply valid credentials, they should be given a notice that they have successfully signed in
  ...
  scenario "User signs in with valid credentials" do
    user = FactoryGirl.create(:user, email: "sathvik@yahoo.com", password: "password")
    visit(root_path)
    click_link 'Sign In'
